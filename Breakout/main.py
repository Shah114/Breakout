#Welcome to Breakout game by SHAH
import pygame
...
live_ball = False
game_over = 0
sound_wall = pygame.mixer.Sound('Breakout/wall.mp3')
...
class game_ball():
    ...
    def move(self):
        ...
        #start off with the assumption that the wall has been destroyed completaly
        wall_destroyed = 1
        row_count = 0
